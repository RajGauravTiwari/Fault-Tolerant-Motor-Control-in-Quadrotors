...
#change theta(1st parameter for roll),For pitch change the second parameter
#test cases angles-> (+-10),(+-20),(+-30) for roll and pitch each ->total of 12 combinations

    print("-- Roll Theta at 80% thrust")
